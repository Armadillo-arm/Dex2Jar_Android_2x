										...
										public void visitEnd ( )
											{
												...
												System.out.println("dex->class:"+className);
												byte[] data;
												try
													{
												...
												//if ( !new File ( dist + "/" + className + ".class" ).getParentFile ( ).exists ( ) )new File ( dist + "/" + className + ".class" ).getParentFile ( ).mkdirs ( );
												try
													{
														/*FileOutputStream outputStream;
														try
															{
																outputStream = new FileOutputStream ( new File ( dist + "/" + className + ".claa" ) );
